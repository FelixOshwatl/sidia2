              ...
              <template v-slot:default>
                <thead>
                  <tr>
                    ...
                    <th class="text-left" scope="col">Rincian</th>
                    <th class="text-left" scope="col" v-if="idPeminjaman.idSetuju == 'TRX0002'">
                      Action
                    </th>
                  ...
                  <tr v-for="item in dataListDocument" :key="item.name">
                    ...
                    <td class="text-center">
                      <v-btn
                        ...
                        icon
                        color="success"
                        v-if="idPeminjaman.idSetuju == 'TRX0002'"
                      >
...
export default {
  ...
  mounted() {
    console.log("sssssssssss", this.idPeminjaman.idPeminjaman)
    this.getStatus()
    this.getDocument()
  },
  async created() {
    console.log("sssssssssss", this.idPeminjaman.idSetuju);
    console.log("sssssssssss12", this.idPeminjaman.idPeminjaman);
  ...
  methods: {
    ...
    getStatus() {
      const itemData = [];
      console.log(this.idPeminjaman.idPeminjaman);
      this.isLoading = true;
      this.$axios
        .get(
          "/arsip/" +
            this.idPeminjaman.idPeminjaman +
            "/getDataAproovalPeminjamanArsip",
          {
            params: {},
          }
        )
    ...
    getDocument() {
      const itemDocument = [];
      console.log("testt disini", this.idPeminjaman.idSetuju);
      this.isLoading = true;
      this.$axios
        .get(
          "/arsip/" +
            this.idPeminjaman.idPeminjaman +
            "/getListPeminjamanArsip",
          {
            params: {},
          }
        )
        .then((res) => {
          ...
          this.isLoading = false;
          console.log("testt no surat", itemDocument);
