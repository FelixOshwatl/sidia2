                    ...
                    <td>
                      <v-tooltip left>
                        <template v-slot:activator="{ on, attrs }">
                          <td color="primary" dark v-bind="attrs" v-on="on">
...
export default {
  ...
  methods: {
    ...
    getStatus() {
      ...
      this.isLoading = true;
      this.$axios
        .get("/arsip/getStatusPemindahan/" + this.idPemindahan + "", {
          params: {},
        })
        .then((res) => {
    ...
    getDocument() {
      ...
      this.isLoading = true;
      this.$axios
        .get("/arsip/getDaftarPemindahan/" + this.idPemindahan + "", {
          params: {},
        })
        .then((res) => {
